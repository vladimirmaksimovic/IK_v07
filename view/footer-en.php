  ...
  <div class="container">
    <div class="row p-4">
      <div class="col-md-4 col-sm-12">
        ...
        <ul>
          <li>
            <a href="index-en.php"><i class="fas fa-home"></i> Home</a>
          </li>
          <li>
            <a href="events-en.php"><i class="fas fa-bicycle"></i>
              Acivities</a>
          </li>
          <!-- <li>
            <a href="workshop.php-en" class="workshop-title"><i class="fas fa-paint-brush"></i>
              Creative Burrow</a>
          </li> -->
          <li>
            <a href="gallery-en.php"><i class="fas fa-images"></i>
              Gallery</a>
          </li>
          <li>
            <a href="about-en.php"><i class="fas fa-address-card"></i> About Artist</a>
          </li>
        </ul>
      </div>
      <div class="col-md-4 col-sm-12" id="contact_bg">
        ...
        <ul>
          <li>Address:</li>
          <li>
            <i class="fas fa-map-marker-alt"></i> Trg srpskih ratnika, 36000 Kraljevo, Srbija
          </li>
          <li>Contact phone:</li>
          <li>
