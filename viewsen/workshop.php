  ...
  <section class="container">
    <article class="pt-5 pl-4 pr-4">
      <h1 class="text-center pb-4">
        Creative burrow (colorful world of imagination and inspiration)
      </h1>
      <p class="text-justify">
        Working with children in workshops is conceptualized as one of great fun
        an adventure for both children and the painter. Workshop participants
        exploring their art and creativity first, then slowly
        get acquainted with various materials and techniques of work. They
        freely and seamlessly experiment and explore the media they can
        best to play and then perform small pieces of art.
        Young creators learn, think, and verbally defend their concepts and
        accomplished work on this subject. The workshop itself is not designed to be
        only the talented come together and it is a place of fusion
        idea and energy. Attendees in a fun way through constructive
        they learn and modify their drawing, they play with colors, they think about
        recycling, redesigning, designing, animating their drawings, designing
        small comics.
      </p>
      <p class="text-justify">
        The workshop collaborates with kindergartens, cultural institutions, galleries and
        museums. Thus, students gain basic knowledge of the rules of conduct
        in the gallery. With the constant impetus for intellectual upgrading and
        perfecting, results spontaneously come into being in the form of created ones
        works, consolidation of views on works of art and other works and
